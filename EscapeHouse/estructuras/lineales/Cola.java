...
public class Cola {
    ...
    public boolean poner(Object obj){
        ...
        if(esVacia()){ //caso especial por si la pila esta vacía
    ...
    public boolean sacar(){
        ...
        if(this.frente!=null){
            ...
            if(this.frente==null){//verifica si es el ultimo elemento de la Cola
                this.fin=null;
            }
            listo=true;
        }
    ...
    public Object obtenerFrente(){
        ...
        if(!esVacia()){//verifica que no este vacia y devuelve el elemento en el frente
            elem = frente.getElem();
        }
    ...
    public Cola clone(){
        ...
        while (n1!=null){//se ejecuta hasta que la Cola este vacia
    ...
    public String toString(){
        ...
        if(!esVacia()){
            ...
            while (n1!=null){
                ...
                n1 = n1.getEnlace();
                if(n1!=null){//si faltan elementos por añadir a la lista, separa cada uno con ","
                    lista+=",";
                }
            }
            lista +="]";
